	...
	<div class="my-weekplan-container">
		...
		<div class="weekplan-header">
			<div class="selectWeekPlan">
				...
				<div v-if="!isNameValid && hasSelectedWeekPlanChanged" class="errors">
					* Invalid Name
				</div>
				...
				>
					...
					<div class="meals">
						<div class="lunch" :class="{ free: !dailyPlan.lunch }">
							...
							<div v-else class="add" @click="showRecipeList('lunch', index)">
						...
						<div class="dinner" :class="{ free: !dailyPlan.dinner }">
							...
							<div v-else class="add" @click="showRecipeList('dinner', index)">
								<i class="las la-plus" style="font-size: 48px"></i>
							</div>
						</div>
					</div>
		...
		>
			<div class="recipeList" v-if="modalMode === 'recipeList'">
				...
				<button class="createRecipeButon" @click="modalMode = 'createRecipe'">
					Add new recipe
				</button>
...
import { Meals } from '@/profile/components/MyWeekPlan/WeekPlanTypes';
